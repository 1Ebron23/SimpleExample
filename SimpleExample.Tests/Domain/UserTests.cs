...
public class UserTests
{
    ...
    public void Constructor_WithValidData_ShouldCreateUser()
    {
        ...
        user.LastName.Should().Be("Meikalainen");
    ...
    {
        // Act
        Action act = () => new User("", "Meikalainen", "test@test.com");

        // Assert
        act.Should().Throw<ArgumentException>()
           .WithMessage("*Etunimi ei voi olla tyhja*");
    }
    ...
    {
        // Act
        Action act = () => new User("AB", "Meikalainen", "test@test.com");

        // Assert
        act.Should().Throw<ArgumentException>()
           .WithMessage("*Etunimen tulee olla vahintaan 3 merkkia pitka*");
    }
    ...
    public void Constructor_WithEmptyLastName_ShouldThrowArgumentException()
    {
        ...
        // Assert
        act.Should().Throw<ArgumentException>()
           .WithMessage("*Sukunimi ei voi olla tyhja*");
    }
    ...
    public void Constructor_WithTooShortLastName_ShouldThrowArgumentException()
    {
        ...
        // Assert
        act.Should().Throw<ArgumentException>()
           .WithMessage("*Sukunimen tulee olla vahintaan 3 merkkia pitka*");
    }
    ...
    {
        // Act
        Action act = () => new User("Matti", "Meikalainen", "invalid-email");
    ...
    {
        // Act
        Action act = () => new User(null!, "Meikalainen", "test@test.com");
